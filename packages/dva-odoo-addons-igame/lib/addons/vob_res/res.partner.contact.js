    ...
    return {
      ...
      effects: {
                ...
                case 0:
                  ...
                  fn = function fn(payload) {
                    var id = payload.id,
                        ...
                        mock = _payload$mock === void 0 ? 'rename' : _payload$mock;
                    var method = 'write';
                    var args = [id, {
                      name: name
                    }];
                    var callback = 'rename_callback';
                    return {
                      method: method,
                      args: args,
                      mock: mock,
        ...
        _regenerator.default.mark(function rename_callback(_ref4, _ref5) {
          ...
          return _regenerator.default.wrap(function rename_callback$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  payload = _ref4.payload;
                  call = _ref5.call, put = _ref5.put, select = _ref5.select;
                  _payload$params = payload.params, id = _payload$params.id, name = _payload$params.name, result = payload.data;
          ...
          }, rename_callback, this);
        }),
        search:
        /*#__PURE__*/
        _regenerator.default.mark(function search(_ref6, _ref7) {
          var payload, call, put, select, _payload$domain, domain, fields, _payload$mock2, mock, dm1;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  _payload$domain = payload.domain, domain = _payload$domain === void 0 ? [] : _payload$domain, fields = payload.fields, _payload$mock2 = payload.mock, mock = _payload$mock2 === void 0 ? 'search' : _payload$mock2;
                  dm1 = [['type', '=', 'contact']];
                  _context3.next = 6;
                  return put({
                    type: '_search',
