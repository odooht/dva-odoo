...
class Bridge extends Component {
    ...
    render() {
        ...
        return <div>
            ...
            <div>login:{JSON.stringify(login)}</div>
            <div>id:{JSON.stringify(id)}</div>
            <div>ids:{JSON.stringify(ids)}</div>
            <div>contact:</div>
            <div>contact:{JSON.stringify(contact)}</div>
            <div>contacts:</div>
            <ul>
              {contacts.map((contact, i) => <li key={i}>{JSON.stringify(contact)}</li>) }
            </ul>


            <div>partners:</div>
            <div>partners:{JSON.stringify(partners)}</div>
            <div>odoo:{JSON.stringify(this.props.odooData)}</div>
            <div>users:{JSON.stringify(odooUsers)}</div>
